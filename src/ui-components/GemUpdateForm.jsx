...
import { getGem } from "../graphql/queries";
import { updateGem } from "../graphql/mutations";
...
export default function GemUpdateForm(props) {
  const {
    id: idProp,
    gem: gemModelProp,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = gemRecord
      ? { ...initialValues, ...gemRecord }
      : initialValues;
  ...
  const [gemRecord, setGemRecord] = React.useState(gemModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getGem.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getGem
        : gemModelProp;
  ...
  React.useEffect(resetStateValues, [gemRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateGem.replaceAll("__typename", ""),
            variables: {
              input: {
                id: gemRecord.id,
                ...modelFields,
      ...
      {...getOverrideProps(overrides, "GemUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || gemModelProp)}
